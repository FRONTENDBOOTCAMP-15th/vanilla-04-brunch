class HeaderComponent extends HTMLElement {
  ...
  render() {
    ...
    this.innerHTML = `<div class="header">
      <img class="logo" src="./img/black_logo.png" alt="로고" />
      <div class="bundle">
        <!-- 사용자 로그인시 나올 종 -->
        <!-- <img class="bell" src="./img/bell.png" alt="종 아이콘" /> -->
        <img class="search" src="./img/search_icon.png" alt="검색 아이콘" />
      
        <!-- 사용자 미로그인시 나올 버튼-->
        <button>시작하기</button>

        <!-- 사용자 로그인시 나올 프로필 사진 -->
        <!-- <img class="profile" src="./img/profile_header.png" alt="사용자 프로필" /> -->
      </div>
    </div>`;
  }
